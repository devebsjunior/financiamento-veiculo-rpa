...
'filesystems.disks.s3.report','filesystems.links./home/edsonsouza/projetos/financiamento-veiculo-rpa/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','users.index','users.store','users.show','users.update',
'users.destroy','clientes.index','clientes.store','clientes.show','clientes.update',
'clientes.destroy','veiculos.index','veiculos.store','veiculos.show','veiculos.update',
'veiculos.destroy','financiamentos.index','financiamentos.store','financiamentos.show','financiamentos.update',
'financiamentos.destroy','login','storage.local','storage.local.upload',);
...
'usuarios.create','usuarios.index','veiculos.form','veiculos.index','vendor.l5-swagger.index',
'welcome','l5-swagger::index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_URL','APP_MAINTENANCE_DRIVER','BCRYPT_ROUNDS',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','JWT_SECRET','FILESYSTEM_DISK',
'AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_ENDPOINT',
'AWS_USE_PATH_STYLE_ENDPOINT','OTEL_SERVICE_NAME','OTEL_EXPORTER_OTLP_PROTOCOL','OTEL_EXPORTER_OTLP_ENDPOINT','OTEL_SERVICE_NAME',
'OTEL_EXPORTER_OTLP_ENDPOINT','OTEL_RESOURCE_ATTRIBUTES','DB_USERNAME','DB_PASSWORD','SESSION_DRIVER',
'CACHE_DRIVER','QUEUE_CONNECTION','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',);
