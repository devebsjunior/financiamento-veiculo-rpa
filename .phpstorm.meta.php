    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Services\Contracts\CryptoServiceInterface' => \App\Services\CryptoService::class,
            'App\Services\Contracts\TokenServiceInterface' => \App\Services\TokenService::class,
            'App\Services\Contracts\UserServiceInterface' => \App\Services\UserService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/edsonsouza/projetos/financiamento-veiculo-rpa/public/storage' => 'string',
            'kafka.brokers' => 'string',
            'kafka.securityProtocol' => 'string',
            'kafka.sasl.mechanisms' => 'string',
            'kafka.sasl.username' => 'NULL',
            'kafka.sasl.password' => 'NULL',
            'kafka.consumer_group_id' => 'string',
            'kafka.consumer_timeout_ms' => 'integer',
            'kafka.offset_reset' => 'string',
            'kafka.auto_commit' => 'boolean',
            'kafka.sleep_on_error' => 'integer',
            'kafka.partition' => 'integer',
            'kafka.compression' => 'string',
            'kafka.debug' => 'boolean',
            'kafka.flush_retry_sleep_in_ms' => 'integer',
            'kafka.flush_retries' => 'integer',
            'kafka.flush_timeout_in_ms' => 'integer',
            'kafka.cache_driver' => 'string',
            'kafka.message_id_key' => 'string',
            ...
            'l5-swagger.defaults.servers.0.url' => 'string',
            'l5-swagger.defaults.servers.0.description' => 'string',
            ...
            'l5-swagger.defaults.scanOptions.generator_factory' => 'NULL',
            ...
            'open-telemetry.service_name' => 'string',
            'open-telemetry.exporter.endpoint' => 'string',
            'open-telemetry.exporter.protocol' => 'string',
            'open-telemetry.instrumentation.requests' => 'boolean',
            'open-telemetry.instrumentation.database' => 'boolean',
            'open-telemetry.instrumentation.redis' => 'boolean',
            'open-telemetry.instrumentation.queues' => 'boolean',
...
'image.default','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit',
'hashing.argon.memory','hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login',
'concurrency.default','view.paths','view.compiled','app.name','app.env',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/edsonsouza/projetos/financiamento-veiculo-rpa/public/storage','kafka.brokers',
'kafka.securityProtocol','kafka.sasl.mechanisms','kafka.sasl.username','kafka.sasl.password','kafka.consumer_group_id',
'kafka.consumer_timeout_ms','kafka.offset_reset','kafka.auto_commit','kafka.sleep_on_error','kafka.partition',
'kafka.compression','kafka.debug','kafka.flush_retry_sleep_in_ms','kafka.flush_retries','kafka.flush_timeout_in_ms',
'kafka.cache_driver','kafka.message_id_key','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'l5-swagger.documentations.default.paths.annotations','l5-swagger.defaults.servers.0.url','l5-swagger.defaults.servers.0.description','l5-swagger.defaults.routes.docs','l5-swagger.defaults.routes.oauth2_callback',
...
'l5-swagger.defaults.paths.docs','l5-swagger.defaults.paths.views','l5-swagger.defaults.paths.base','l5-swagger.defaults.paths.excludes','l5-swagger.defaults.scanOptions.generator_factory',
'l5-swagger.defaults.scanOptions.default_processors_configuration','l5-swagger.defaults.scanOptions.analyser','l5-swagger.defaults.scanOptions.analysis','l5-swagger.defaults.scanOptions.processors','l5-swagger.defaults.scanOptions.pattern',
...
'l5-swagger.defaults.ui.display.dark_mode','l5-swagger.defaults.ui.display.doc_expansion','l5-swagger.defaults.ui.display.filter','l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant',
'l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','open-telemetry.service_name',
'open-telemetry.exporter.endpoint','open-telemetry.exporter.protocol','open-telemetry.instrumentation.requests','open-telemetry.instrumentation.database','open-telemetry.instrumentation.redis',
'open-telemetry.instrumentation.queues','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'session.partitioned','session.serialization','excel.exports.chunk_size','excel.exports.pre_calculate_formulas','excel.exports.strict_null_comparison',
...
'excel.temporary_files.remote_disk','excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','prometheus.enabled','prometheus.urls.default',
'prometheus.allowed_ips','prometheus.default_namespace','prometheus.middleware','prometheus.actions.render_collectors','prometheus.wipe_storage_after_rendering',
'prometheus.cache','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified','jwt.auth',);
        registerArgumentsSet('routes', 
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','users.index','users.store',
'users.show','users.update','users.destroy','clientes.index','clientes.store',
'clientes.show','clientes.update','clientes.destroy','veiculos.index','veiculos.store',
'veiculos.show','veiculos.update','veiculos.destroy','financiamentos.index','financiamentos.store',
'financiamentos.show','financiamentos.update','financiamentos.destroy','login','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.login','clientes.create','clientes.edit','clientes.form','clientes.index',
'dashboard','financiamentos.form','financiamentos.index','l5-swagger::index','layouts.app',
'notifications::email','ponto.index','usuarios.create','usuarios.index','veiculos.form',
'veiculos.index','vendor.l5-swagger.index','vendor.notifications.email','welcome','l5-swagger::index',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_URL','L5_SWAGGER_CONST_HOST',
...
'SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','QUEUE_CONNECTION','CACHE_STORE',
...
'MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','VITE_APP_NAME','JWT_SECRET',
'FILESYSTEM_DISK','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET',
'AWS_ENDPOINT','AWS_USE_PATH_STYLE_ENDPOINT','OTEL_SERVICE_NAME','OTEL_EXPORTER_OTLP_PROTOCOL','OTEL_EXPORTER_OTLP_ENDPOINT',
'KAFKA_BROKER_LIST','KAFKA_CONSUMER_GROUP_ID',);
