...
class UserController extends Controller
{
  ...
  {
    $dataHora = now()->timezone('America/Sao_Paulo')->format('Y-m-d_H-i-s');
    $nomeArquivo = "Lista-de-usuarios-Financiamento-Veiculo-RPA-_{$dataHora}.xlsx";
    return Excel::download(new UsersExport, $nomeArquivo);
  }
}
