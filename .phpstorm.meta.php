...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./mnt/c/minio_data/financiamento-veiculos/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./mnt/c/minio_data/financiamento-veiculos/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.serialization','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'l5-swagger.defaults.paths.excludes','l5-swagger.defaults.scanOptions.generator_factory','l5-swagger.defaults.scanOptions.default_processors_configuration','l5-swagger.defaults.scanOptions.analyser','l5-swagger.defaults.scanOptions.analysis',
...
'l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant','l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','storage.local','storage.local.upload',);
...
'JWT_SECRET','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
